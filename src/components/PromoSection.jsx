  ...
  return (
    <section className="max-w-7xl mx-auto px-4 space-y-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
        ...
        <div className="flex flex-col items-center gap-2">
          <BadgeDollarSign className="text-blue-500" size={32}/>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        {/* WOMEN STYLE */}
        <div className="rounded-xl overflow-hidden bg-gray-100 flex items-center">
          ...
          <div className="w-1/2 p-6 space-y-3">
            ...
            <Link
              ...
              className="inline-block border px-4 py-2 rounded-full hover:bg-black hover:text-white transition"
            >
              Shop Now
            </Link>
          </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          {/* HANDBAG */}
          <div className="relative bg-[#f5e9dc] rounded-xl p-6 flex flex-col justify-between">
          ...
          {/* WATCH */}
          <div className="relative bg-[#f1f1f1] rounded-xl p-6 flex flex-col justify-between">
          ...
          {/* BACKPACK */}
          <div className="relative col-span-2 bg-[#e8ded3] rounded-xl p-6 flex items-center justify-between">
